...
python3 main.py --model /maasjfs/hf_models/meta-llama3.1/Meta-Llama-3.1-8B-Instruct --rotate --svd \
  --w_bits 4 --a_bits 4 --k_bits 16 --v_bits 16 --w_clip --v_groupsize 128 --k_groupsize 128 \
  --a_asym --k_asym --v_asym --rotate_mode orthogonal_procrustes \
  --indices_path rms_norm_feature_hadamard_alter/100/LLaMA-3-8B-4.npy --fp32_had --seed 0
